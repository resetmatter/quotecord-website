...
-- Function to check premium status by Discord ID (checks feature flags first)
...
-- Function to check if user has storage quota available (Premium: Unlimited, Free: 50)
...
-- ============================================
-- FEATURE FLAGS TABLE (for testing/overrides)
-- ============================================
