...
export const metadata = {
  title: 'Templates - Quotedis',
  description: 'Explore the 3 professionally designed templates available in Quotedis.',
}
          ...
          <div className="relative glass rounded-3xl p-12 text-center overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-dark-400 mb-8 max-w-xl mx-auto">
                All templates are available in the free tier. Add Quotedis to your server and start creating.
              </p>
